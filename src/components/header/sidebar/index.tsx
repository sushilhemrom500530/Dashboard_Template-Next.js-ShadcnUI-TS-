    ...
    <>
      ...
      <div
        className={`fixed inset-0 bg-black/50 z-20 lg:hidden transition-opacity ${
          navOpened ? "opacity-100 block" : "opacity-0 hidden"
        }`}
      ...
      >
        <div className="flex items-center flex-col gap-5 h-full">
          ...
          <div className="pt-10 px-2 flex justify-between flex-col h-full">
            ...
            <button className="text-xl font-medium flex items-center gap-3 my-4 px-6 py-3 text-black cursor-pointer hover:text-red-600 transition ">
              Log Out
            </button>
          </div>
        </div>
